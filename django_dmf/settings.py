"""
Django settings for django_dmf project.
...
SECRET_KEY = "django-insecure-i(#xe@&439mztr68l$=-z5)2!xv^=s34fygy@rztc@@l%zcpje"
...
WSGI_APPLICATION = "django_dmf.wsgi.application"
